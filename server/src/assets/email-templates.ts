...
export default class EmailTemplates {
  ...
  static forgotPassword(userName: string, resetLink: string): { subject: string; html: string } {
    return {
      subject: 'Reset Your Password - Uptime Client',
      html: `
        <!DOCTYPE html>
        <html lang="en">
        <head>
        ...
        <body>
          <div class="container">
            ...
            <div class="content">
              ...
              <p>We received a request to reset your password for your Uptime Client account. If you didn't make this request, you can safely ignore this email.</p>
              ...
              <p>Best regards,<br>The Uptime Client Team</p>
            </div>
            <div class="footer">
              ...
              <p>&copy; 2025 Uptime Client. All rights reserved.</p>
            </div>
          </div>
        </body>
        </html>
  ...
  static verifyAccount(userName: string, verificationLink: string): { subject: string; html: string } {
    return {
      subject: 'Verify Your Account - Uptime Client',
      html: `
        <!DOCTYPE html>
        <html lang="en">
        <head>
        ...
        <body>
          <div class="container">
            ...
            <div class="content">
              ...
              <p>Thank you for signing up for Uptime Client. To complete your registration and start monitoring your services, please verify your email address.</p>
              <div class="highlight">
              ...
              <p>Once verified, you'll have full access to all Uptime Client features.</p>
              <p>Best regards,<br>The Uptime Client Team</p>
            </div>
            <div class="footer">
              <p>This email was sent because you recently created an account with Uptime Client.</p>
              <p>&copy; 2025 Uptime Client. All rights reserved.</p>
            </div>
          </div>
        </body>
  ...
  static loginWithLink(userName: string, loginLink: string): { subject: string; html: string } {
    return {
      subject: 'Your Login Link - Uptime Client',
      html: `
        <!DOCTYPE html>
        <html lang="en">
        <head>
        ...
        <body>
          <div class="container">
            ...
            <div class="content">
              <h2>Hello ${userName},</h2>
              <p>You requested a secure login link for your Uptime Client account. This link allows you to sign in without entering your password.</p>
              <div class="info">
            ...
            <div class="footer">
              <p>This email was sent because you requested a login link for Uptime Client.</p>
              <p>&copy; 2025 Uptime Client. All rights reserved.</p>
            </div>
          </div>
        </body>
  ...
  static welcome(userName: string): { subject: string; html: string } {
    return {
      subject: 'Welcome to Uptime Client!',
      html: `
        <!DOCTYPE html>
        <html lang="en">
        <head>
          <meta charset="UTF-8">
          <meta name="viewport" content="width=device-width, initial-scale=1.0">
          <title>Welcome to Uptime Client</title>
          <style>
            body { font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; margin: 0; padding: 0; background-color: #f4f4f4; }
            .container { max-width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 8px; overflow: hidden; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1); }
        ...
        <body>
          <div class="container">
            <div class="header">
              <h1>🎉 Welcome to Uptime Client!</h1>
            </div>
            <div class="content">
              <h2>Hello ${userName},</h2>
              <p>Welcome to Uptime Client! We're excited to have you on board. Your account has been successfully created and verified.</p>
              <div class="features">
              ...
              <p>Happy monitoring!<br>The Uptime Client Team</p>
            </div>
            <div class="footer">
              <p>&copy; 2025 Uptime Client. All rights reserved.</p>
            </div>
  ...
  static passwordResetConfirmation(userName: string): { subject: string; html: string } {
    return {
      subject: 'Password Reset Successful - Uptime Client',
      html: `
        <!DOCTYPE html>
        <html lang="en">
        <head>
        ...
        <body>
          <div class="container">
            ...
            <div class="content">
              <h2>Hello ${userName},</h2>
              <div class="success">
                <strong>✓ Success!</strong> Your password has been successfully reset. You can now sign in to your Uptime Client account with your new password.
              </div>
